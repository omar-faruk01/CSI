...
public class SimpleJdbc extends HttpServlet 
{
    ...
    {        
		...
		query = "select  distinct lastName,  firstName from Address";
		
		out.println("<html><head><title>Address Table Report</title>");	 
		out.println("</head><body>");
		
		out.print( "<br /><b><center><font color=\"RED\"><H2>Address Table Report</H2></font>");
